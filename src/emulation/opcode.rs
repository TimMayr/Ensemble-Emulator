...
pub fn init() -> HashMap<u8, &'static OpCode> {
    OPCODES.set(vec![// ADC
                     ...
                     OpCode::new(0x7D,
                                 "ADC",
                                 AbsoluteIndexRead(Source::X,
                                                   Target::TEMP,
                                                   MicroOpCallback::ADC)),
                     OpCode::new(0x79,
                                 "ADC",
                                 AbsoluteIndexRead(Source::Y,
                                                   Target::TEMP,
                                                   MicroOpCallback::ADC)),
                     OpCode::new(0x61,
                                 "ADC",
                     ...
                     OpCode::new(0xE7,
                                 "*ISC",
                                 ZeroPageRMW(Target::TEMP, MicroOpCallback::ISC)),
                     OpCode::new(0xF7,
                                 "*ISC",
                                 ZeroPageIndexRMW(Source::X, MicroOpCallback::ISC)),
                     OpCode::new(0xEF,
                                 "*ISC",
                                 AbsoluteRMW(Target::TEMP, MicroOpCallback::ISC)),
                     OpCode::new(0xFF,
                                 "*ISC",
                                 AbsoluteIndexRMW(Source::X, MicroOpCallback::ISC)),
                     OpCode::new(0xFB,
                                 "*ISC",
                                 AbsoluteIndexRMW(Source::Y, MicroOpCallback::ISC)),
                     OpCode::new(0xE3, "*ISC", IndexedIndirectRMW(MicroOpCallback::ISC)),
                     OpCode::new(0xF3, "*ISC", IndirectIndexedRMW(MicroOpCallback::ISC)),
                     OpCode::new(0xBB,
                                 "*LAS",
                                 AbsoluteIndexRead(Source::Y,
                                                   Target::TEMP,
                     ...
                     OpCode::new(0x77,
                                 "*SAX",
                                 ZeroPageIndexWrite(Source::TEMP,
                                                    Source::X,
                                                    MicroOpCallback::SAX)),
                     OpCode::new(0x6F,
                                 "*SAX",
                     ...
                     OpCode::new(0x9F,
                                 "*SHA",
                                 AbsoluteIndexWrite(Source::TEMP,
                                                    Source::Y,
                                                    MicroOpCallback::SHA)),
                     OpCode::new(0x93,
                                 "*SHA",
