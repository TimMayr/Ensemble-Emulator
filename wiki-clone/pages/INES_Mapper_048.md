...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/INES_Mapper_048) | View [other pages](Special_AllPages.xhtml#INES_Mapper_048)

iNES Mapper 048 represents Taito's [TC0690](Taito_TC0690_pinout.xhtml "Taito TC0690 pinout"). It also represents a superset of the abilities provided the [TC0190+PAL16R4](Taito_TC0190_pinout.xhtml "Taito TC0190 pinout") boards (which have no interrupts). 

To the best of our knowledge, the following six games require this mapper: 

  * [Bakushou!! Jinsei Gekijou 3](https://nescartdb.com/profile/view/2255/bakushou-jinsei-gekijou-3)
  * Bubble Bobble 2 (J)
  * [Don Doko Don 2](https://nescartdb.com/profile/view/4519/don-doko-don-2)
  * Captain Saver (J)
  * Jetsons, The - Cogswell's Caper! (J)
  * [Flintstones, The - The Rescue of Dino & Hoppy (J)](https://forums.nesdev.org/viewtopic.php?p=241376#p241376)
     ...
     Notes:
     --------------------------
     Most dumps of mapper 048 games floating around are erroneously labelled as [mapper 033](INES_Mapper_033.xhtml "INES Mapper 033").  Mapper 033 does not
     have IRQs, mapper 048 does, and mirroring on each is handled a bit differently.  Apart from that, the two are
     very similar.
     
     This mapper is very similar to [MMC3](MMC3.xhtml "MMC3") in a lot of ways, including how the IRQ counter operates.
...
Different games seem to require subtly different IRQ timing. Because the cartridges are so rare, it's unclear but possible that there's actually yet another ASIC that we have not yet documented. [[1]](https://forums.nesdev.org/viewtopic.php?t=18277)

Categories: [INES Mappers](Category_INES_Mappers.xhtml), [Mappers with scanline IRQs](Category_Mappers_with_scanline_IRQs.xhtml), [MMC3-like mappers](Category_MMC3_like_mappers.xhtml)
