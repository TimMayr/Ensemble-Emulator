...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Visual6502wiki/6502_Interrupt_Hijacking) | View [other pages](Special_AllPages.xhtml#Visual6502wiki_6502_Interrupt_Hijacking)

The following is based upon drawing the node and transistor networks out on paper from visual6502 data, and conducting experiments with the simulator. In explaining the various behaviors, references are made to 6502 clock states and stages of interrupt recognition that are described in [6502 Timing States](Visual6502wiki_6502_Timing_States.xhtml "Visual6502wiki/6502 Timing States") and [6502 Interrupt Recognition Stages and Tolerances](Visual6502wiki_6502_Interrupt_Recognition_Stages_and_Tolerances.xhtml "Visual6502wiki/6502 Interrupt Recognition Stages and Tolerances"), which may be used as primers for this exposition. 
...
## Contents
  ...
  * 1 Introduction
  * 2 NMI Hijacking IRQ/BRK
  * 3 RES Hijacking NMI and IRQ/BRK
  * 4 BRK Protected from NMI vs. Unprotected from RES
  * 5 Demonstrations
...
First introduced to this wiki by the link, "late NMI", in [6502 Timing of Interrupt Handling](Visual6502wiki_6502_Timing_of_Interrupt_Handling.xhtml "Visual6502wiki/6502 Timing of Interrupt Handling"), it is possible for higher-priority interrupts to hijack lower priority interrupts during the BRK instruction that is serving them. 
...
If NMI is released under the above circumstances before T1 phase 1 is clocked in, then the NMI is entirely missed. See also the "lost NMI" condition noted in [6502 Timing of Interrupt Handling](Visual6502wiki_6502_Timing_of_Interrupt_Handling.xhtml "Visual6502wiki/6502 Timing of Interrupt Handling"). 
...
Releasing RES _two_ cycles later results in starting a new BRK instruction that jumps normally to the RES handler. This is because RES is held down long enough to prevent RES recognition stage 2 from being shut off by the already-running BRK instruction, and stage 2 still being alive will cause the next fetch cycle to start a new BRK instruction. The full description of what happens is covered by the worst-case RES invocation section under "Tolerances" in [6502 Interrupt Recognition Stages and Tolerances](Visual6502wiki_6502_Interrupt_Recognition_Stages_and_Tolerances.xhtml "Visual6502wiki/6502 Interrupt Recognition Stages and Tolerances"). Demonstrations of all cases are present there. 
...
[Thwarted full hijack of an IRQ by RES.](https://visual6502.org/JSSim/expert.html?graphics=f&steps=34&logmore=Execute,nmi,res,irq,~NMIG,RESP,IRQP,p2,INTG,RESG,State,tcstate,TState,Phi&a=0200&d=EAEA&a=20FD&d=4C20F9&a=F810&d=40&a=F910&d=4C20F9&a=F920&d=584C0002&a=F930&d=4C20F9&a=FA30&d=486840&a=FFFA&d=10F820F930FA&irq0=11&irq1=12&reset0=21&reset1=22)
...
[Successful half-hijack of an IRQ by RES.](https://visual6502.org/JSSim/expert.html?graphics=f&steps=36&logmore=Execute,nmi,res,irq,~NMIG,RESP,IRQP,p2,INTG,RESG,State,tcstate,TState,Phi&a=0200&d=EAEA&a=20FD&d=4C20F9&a=F810&d=40&a=F910&d=4C20F9&a=F920&d=584C0002&a=F930&d=4C20F9&a=FA30&d=486840&a=FFFA&d=10F820F930FA&irq0=11&irq1=12&reset0=23&reset1=24)
...
"late NMI" and "lost NMI" in [6502 Timing of Interrupt Handling](Visual6502wiki_6502_Timing_of_Interrupt_Handling.xhtml "Visual6502wiki/6502 Timing of Interrupt Handling") [6502 Timing States](Visual6502wiki_6502_Timing_States.xhtml "Visual6502wiki/6502 Timing States") [6502 Interrupt Recognition Stages and Tolerances](Visual6502wiki_6502_Interrupt_Recognition_Stages_and_Tolerances.xhtml "Visual6502wiki/6502 Interrupt Recognition Stages and Tolerances")
