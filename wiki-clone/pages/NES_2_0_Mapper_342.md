...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/NES_2.0_Mapper_342) | View [other pages](Special_AllPages.xhtml#NES_2_0_Mapper_342)

NES 2.0 Mapper 342 is used for the homebrew COOLGIRL multicart. In addition to native registers, it can simulate about 25 commercial-era mappers on a hardware level. It can address up to 128 MiB of PRG-ROM, 512 KiB of CHR-RAM, and 32 KiB of WRAM. Like the [COOLBOY](NES_2_0_Mapper_268.xhtml "NES 2.0 Mapper 268") mapper that inspired it, CHR-RAM is filled with pattern data copied from PRG-ROM by the multicart menu after a game has been selected. Its UNIF board name is just **COOLGIRL**. 
...
# See also
  ...
  * [Project on GitHub with schematic and CPLD source code](https://github.com/ClusterM/coolgirl-multirom-builder)
  * [FCEUX implementation](https://github.com/TASEmulators/fceux/blob/master/src/boards/coolgirl.cpp)



Categories: [Mappers with flash save](Category_Mappers_with_flash_save.xhtml), [Mappers with large PRG RAM](Category_Mappers_with_large_PRG_RAM.xhtml), [Multi-ASIC mappers](Category_Multi_ASIC_mappers.xhtml), [Multicart mappers](Category_Multicart_mappers.xhtml)
