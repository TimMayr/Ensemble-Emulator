...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Board_table) | View [other pages](Special_AllPages.xhtml#Board_table)

This is a list of North American NES releases, along with their cartridge board and rarity. It could be useful if you seek donor carts with a particular board. The rarity data is way outdated; look at a recent NintendoAge.com newsletter for more current information. The board data is also outdated compared to [NesCartDB](http://bootgod.dyndns.org:7777/); feel free to discuss solutions on [the talk page](Talk_Board_table.xhtml "Talk:Board table"). 

Name | Maker | Rarity | Board   
---|---|---|---  
10 Yard Fight | Nintendo | E | [NROM](NROM.xhtml "NROM")  
1050 in 1 (Japan) | Supervision | A+ | [NES_2.0_Mapper_354](NES_2_0_Mapper_354.xhtml "NES 2.0 Mapper 354")  
110 in 1 (Canada?) | Supervision |  |   
1942 | Capcom | C+ | NROM   
1943 | Capcom | C+ | [UNROM](UxROM.xhtml "UNROM")  
6 in 1 | Caltron | A |   
720 | Mindscape | C | [SGROM](SxROM.xhtml "SGROM")  
8 Eyes | Taxan | C- | [TLROM](TxROM.xhtml "TLROM")  
A Boy and His Blob | Absolute | C | [SLROM](SxROM.xhtml "SLROM")  
Abadox | Milton Bradley | C | SLROM   
Action 52 | Active Enterprises | A | [023-N507](INES_Mapper_228.xhtml "INES Mapper 228")  
Addams Family | Ocean | B | SLROM   
Adv of Bayou Billy | Konami | C- | SLROM   
Adv of Dino Riki | Hudson | C | [CNROM](CNROM.xhtml "CNROM")  
Adv of Lolo | HAL | C+ | [SEROM](SxROM.xhtml "SEROM")  
Adv of Lolo 2 | HAL | B- | [TEROM](TxROM.xhtml "TEROM")  
...
After Burner | Tengen | C+ | [800042-01](INES_Mapper_068.xhtml "INES Mapper 068")  
Air Fortress | HAL | C | [SJROM](SxROM.xhtml "SJROM")  
Airwolf | Acclaim | C | [SHROM](SxROM.xhtml "SHROM")  
Al Unser Racing | Data East | C | [SKROM](SxROM.xhtml "SKROM")  
...
Arch Rivals | Acclaim | C | [AMROM](AxROM.xhtml "AMROM")  
...
Baby Boomer | [Color Dreams](Color_Dreams.xhtml "Color Dreams") | B- |   
...
Bandit Kings/China | Koei | B- | [ETROM](ExROM.xhtml "ETROM")  
...
Batman Return/Joker | Sunsoft | B- | [NES_BTR](Sunsoft_FME_7.xhtml "FME-7")  
...
Battle Toads | Tradewest | D | [AOROM](AxROM.xhtml "AOROM")  
Battle Toads & Double Dragon | Tradewest | B+ | AOROM   
Battleship | Mindscape | B | CNROM   
Bee 52 | Camerica | B+ |   
Beetlejuice | LJN | C+ | AMROM   
Best of the Best | Electro Brain | B+ | [UOROM](UxROM.xhtml "UOROM")  
Bible Adventures | Wisdom Tree | B+ |   
Bible Adventures (blue label) | [Wisdom Tree](Color_Dreams.xhtml "Color Dreams") | B+ |   
...
Bubble Bath Babes | [Panesian](https://www.nesdev.org/w/index.php?title=Panesian&action=edit&redlink=1 "Panesian \(page does not exist\)") | A+ |   
...
[Bugs Bunny Crazy Castle](https://en.wikipedia.org/wiki/The_Bugs_Bunny_Crazy_Castle "wikipedia:The Bugs Bunny Crazy Castle") | Kemco | B+ | [SBROM](SxROM.xhtml "SBROM")  
...
Castlevania 3 | Konami | C- | [ELROM](ELROM.xhtml "ELROM")  
...
Dragon Warrior 3 | Enix | B+ | [SUROM](SxROM.xhtml "SUROM")  
