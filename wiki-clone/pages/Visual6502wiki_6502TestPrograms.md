...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Visual6502wiki/6502TestPrograms) | View [other pages](Special_AllPages.xhtml#Visual6502wiki_6502TestPrograms)
...
Self-testing (6502 ROMs and programs): 
  ...
  * [Decimal mode tests by Bruce Clark](http://www.6502.org/tutorials/decimal_mode.html) ADC/SBC (exhaustive, tests all four affected flags.) Some specific [Decimal tests here](Visual6502wiki_6502DecimalMode.xhtml "Visual6502wiki/6502DecimalMode").
...
References: 
  ...
  * [Nesdev forum topic: "req: nestest.asm"](https://forums.nesdev.org/viewtopic.php?p=28348#p28348)
  * [Emulator tests](Emulator_tests.xhtml "Emulator tests") nesdevwiki page
