...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/NES_2.0_header_for_ca65) | View [other pages](Special_AllPages.xhtml#NES_2_0_header_for_ca65)

This macro pack for ca65 constructs a 16-byte [NES 2.0](NES_2_0.xhtml "NES 2.0") header. 

A port for cc65 C code is available [NES 2.0 header for cc65](NES_2_0_header_for_cc65.xhtml "NES 2.0 header for cc65")
