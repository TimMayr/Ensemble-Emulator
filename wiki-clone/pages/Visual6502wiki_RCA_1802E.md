...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Visual6502wiki/RCA_1802E) | View [other pages](Special_AllPages.xhtml#Visual6502wiki_RCA_1802E)
...
## Contents
  ...
  * 2 Datapath
    ...
    * 2.2 2\. REGWL, REGWR
    * 2.3 3\. /REGRL, /REGRR
    * 2.4 4\. /EF1234, SELREG0, SELREG2, and REGSEL
    * 2.5 5\. DEC, COUT, CIN
    * 2.6 6\. REG_DB_EN, REG_OUT_EN
    * 2.7 7\. NOUTEN
    * 2.8 8\. /LD_IN, /N_TO_RAB, /IN_RESET, INTDB0~INTDB7
    * 2.9 9\. /SET_P1X2, /P_RAB_OUT, /X_RAB_OUT, /LD_X, /LD_P, LD_FR_DB, LD_FR_N
    * 2.10 10\. /LD_T_FR_PX, LD_T_FR_PX, /T_OUT_EN
    * 2.11 11\. /D_ZERO, D_SHIFT_IN, /D_SHIFT, D_OUT_EN, D_SHIFT_OUT
    * 2.12 12\. B_SHIFT_OUT, B_OUT_EN, /B_SHIFT, /LD_B
    * 2.13 13\. EXT_DB_IN, EXT_DB_OUT
  * 3 Simple logic gates
  * 4 NOR4 layout
  * 5 Resources
...
[File:Rca1802-control-reversed-small.gif](https://www.nesdev.org/w/index.php?title=Special:Upload&wpDestFile=Rca1802-control-reversed-small.gif "File:Rca1802-control-reversed-small.gif")
...
[File:1802 dpth-small.png](https://www.nesdev.org/w/index.php?title=Special:Upload&wpDestFile=1802_dpth-small.png "File:1802 dpth-small.png")
...
[File:Rca1802-detail-annotated.jpg](https://www.nesdev.org/w/index.php?title=Special:Upload&wpDestFile=Rca1802-detail-annotated.jpg "File:Rca1802-detail-annotated.jpg")
...
[File:Rca1802-detail2-nor4.png](https://www.nesdev.org/w/index.php?title=Special:Upload&wpDestFile=Rca1802-detail2-nor4.png "File:Rca1802-detail2-nor4.png")
