...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/16-bit_BCD) | View [other pages](Special_AllPages.xhtml#16_bit_BCD)
...
To understand how curDigit is used, see [Wikipedia:Ring counter](https://en.wikipedia.org/wiki/Ring_counter "wikipedia:Ring counter"). 
...
## External links
  ...
  * [Another 16-bit binary to decimal converter written in PIC assembly](http://www.piclist.com/techref/microchip/math/radix/b2bu-16b5d.htm)
  * [Even faster converters by Omegamatrix](http://forums.nesdev.org/viewtopic.php?f=2&t=11341)
