...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/KrzysioCart) | View [other pages](Special_AllPages.xhtml#KrzysioCart)

The **KrzysioCart** (Chris' MicroSD Cartridge) is a CPLD and SD card based [Flash Cartridge](Category_Flash_Cartridge.xhtml "Category:Flash Cartridge") made by krzysiobal. It is intended to be a lower budget flash cartridge compared to the [Everdrive](Everdrive_N8.xhtml "Everdrive"). The cartridge targets the most commonly used mappers, and supports about 82% of the NES / Famicom game library. [[1]](https://forums.nesdev.org/viewtopic.php?t=15757)
...
The KrzysioCart supports a relatively small number of mappers, specifically supporting only the most popular mappers and a few personal choices. 
  ...
  * [Camerica](INES_Mapper_071.xhtml "INES Mapper 071")
    * [iNES Mapper 071](INES_Mapper_071.xhtml "INES Mapper 071")
  * [Camerica Quattro](INES_Mapper_232.xhtml "INES Mapper 232")
