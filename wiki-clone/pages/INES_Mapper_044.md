...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/INES_Mapper_044) | View [other pages](Special_AllPages.xhtml#INES_Mapper_044)
     ...
     This mapper is an [MMC3](MMC3.xhtml "MMC3") based multicart.  The multicart selects a block of PRG and CHR depending on the
     selected game, and the MMC3 regs act as they normally would within the given block.  For info on MMC3, see
     [mapper 004](MMC3.xhtml "INES Mapper 004").
