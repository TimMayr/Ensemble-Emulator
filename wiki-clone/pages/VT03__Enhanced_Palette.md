...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/VT03%2B_Enhanced_Palette) | View [other pages](Special_AllPages.xhtml#VT03__Enhanced_Palette)

On the VT03 and later consoles, CGRAM is extended from the [original RP2C02](PPU_palettes.xhtml "PPU palettes")'s 32 bytes (disregarding mirrored bytes) to 256 bytes. 
...
## Contents
  ...
  * 1 Regular 2C02 colors
  * 2 Extended colors
  * 3 Inverted extended color numbers
  * 4 Palette Chart
