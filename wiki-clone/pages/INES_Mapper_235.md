...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/INES_Mapper_235) | View [other pages](Special_AllPages.xhtml#INES_Mapper_235)
     ...
     Island music and graphics.  Instead of a ~~PRG~~ _CHR_ ROM, this cart uses a single
...
The four ICs are two [74174s](74174.xhtml "74174"), a [74153](74153.xhtml "74153"), and a [74139](74139.xhtml "74139"). All eleven bits of the register seem to be cleared on reset. 

The 74'153 is configured as two independent 1-of-2 multiplexers with enables. The R bit controls one (selecting between CPUA14 and P) and the M bit controls the other (selecting between PPUA10 and PPUA11). The second multiplexer's enable is the N bit (i.e. 1scA). 

One half of the 74'139 uses the B bits to select between four ROM sockets. The other half decodes /ROMSEL and R/W to create the latch enable for the latches. 

Additional information: [Kevtris's](http://kevtris.org/mappers/bmc_nes/BTL_150in1A.html)
