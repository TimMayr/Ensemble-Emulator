...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Visual6502wiki/6502_Unsupported_Opcodes) | View [other pages](Special_AllPages.xhtml#Visual6502wiki_6502_Unsupported_Opcodes)
...
## examples
  ...
  * [XAA #$5A](http://visual6502.org/JSSim/expert.html?graphics=f&steps=26&a=0&d=a9ffa2f08b5aeaea&loglevel=2&logmore=DPControl) (also known as ANE) with A=FF 
    ...
    * for more detail see the explanation page: [Visual6502wiki/6502 Opcode 8B (XAA, ANE)](Visual6502wiki_6502_Opcode_8B__XAA__ANE_.xhtml "Visual6502wiki/6502 Opcode 8B \(XAA, ANE\)")
