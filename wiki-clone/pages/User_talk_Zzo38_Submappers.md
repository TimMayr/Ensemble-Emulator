...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/User_talk%3AZzo38/Submappers) | View [other pages](Special_AllPages.xhtml#User_talk_Zzo38_Submappers)
...
—[Lidnariq](User_Lidnariq.xhtml "User:Lidnariq") 20:13, 10 September 2012 (MDT) 
  ...
  * 0 or 8KiB PRG RAM → MMC3. 1 KiB PRG RAM → MMC6, and the behavior of the protection register would follow from that. Furthermore, since 1024x8 RAMs are at best ancient, saying "1 KiB RAM implies MMC6 behavior, 0,2ⁿ (n=7,8,9,11,12,13) imply MMC3 behavior, ≥16384 is an error" is unambiguous and seems cleaner to me. 
    * The **counterargument** would invoke the X1-017 IC, since its internal memory (5KiB) isn't directly expressible in NES2.0.
    ...
    —[Lidnariq](User_Lidnariq.xhtml "User:Lidnariq") 01:25, 11 September 2012 (MDT) 

    I can't tell from [INES Mapper 082](Taito_X1_017.xhtml "INES Mapper 082") exactly how the X1-017 is supposed to map its battery-backed memory ("$7000-$6FFF"?), but I'd guess that non-power-of-two memory sizes would round up the same way they do in the Super NES internal header. --[Tepples](User_Tepples.xhtml "User:Tepples") 06:52, 11 September 2012 (MDT)
