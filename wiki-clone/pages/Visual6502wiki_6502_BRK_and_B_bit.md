...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Visual6502wiki/6502_BRK_and_B_bit) | View [other pages](Special_AllPages.xhtml#Visual6502wiki_6502_BRK_and_B_bit)
...
## Contents
  ...
  * 1 the B flag and the various mechanisms
  * 2 IRQ preceding a BRK instruction
  * 3 late NMI will not half-modify vector reads
  * 4 NMI preceding a BRK
  * 5 NMI masked by BRK
  * 6 masking of the stack writes during RESET
  * 7 Resources
...
## Resources
  ...
  * [The B flag](https://archive.nesdev.org/the%20%27B%27%20flag%20&%20BRK%20instruction.txt) by Brad Taylor
  ...
  * [CPU interrupts](CPU_interrupts.xhtml "CPU interrupts") on Nesdev wiki
