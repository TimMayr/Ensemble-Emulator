...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Celius_NTSC_table) | View [other pages](Special_AllPages.xhtml#Celius_NTSC_table)
    ...
    Final note: Tables are meant to be displayed in a fixed-pitch font.
