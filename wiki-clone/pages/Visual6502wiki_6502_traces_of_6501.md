...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Visual6502wiki/6502_traces_of_6501) | View [other pages](Special_AllPages.xhtml#Visual6502wiki_6502_traces_of_6501)
...
## Contents
  ...
  * 1 Pinout differences
  * 2 Sync and BA
  * 3 Pad assignment changes
  * 4 Data Bus Enable
  * 5 Resources
...
The JSSim view of this area: [File:Rdy-sync-no-via-6502d-jssim.png](https://www.nesdev.org/w/index.php?title=Special:Upload&wpDestFile=Rdy-sync-no-via-6502d-jssim.png "File:Rdy-sync-no-via-6502d-jssim.png")

This area on the Rockwell R6502: [File:Rdy-sync-no-via-R6502-balazs.png](https://www.nesdev.org/w/index.php?title=Special:Upload&wpDestFile=Rdy-sync-no-via-R6502-balazs.png "File:Rdy-sync-no-via-R6502-balazs.png")

This area on the 2A03: [File:Rdy-sync-no-via-2A03.png](https://www.nesdev.org/w/index.php?title=Special:Upload&wpDestFile=Rdy-sync-no-via-2A03.png "File:Rdy-sync-no-via-2A03.png")
...
Here's a location where the Rockwell version of the chip has an extra short, compared to the MOS 6502D (and also showing that Nintendo's 2A03 has the MOS version of the layout) [File:Compare-r6502-balazs-2a03-dbe-short.png](https://www.nesdev.org/w/index.php?title=Special:Upload&wpDestFile=Compare-r6502-balazs-2a03-dbe-short.png "File:Compare-r6502-balazs-2a03-dbe-short.png")
