...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/INES_Mapper_DischDocs) | View [other pages](Special_AllPages.xhtml#INES_Mapper_DischDocs)

This article clarifies the terminology used in [Disch's detailed list of over 50 mappers](http://www.romhacking.net/documents/362/) at romhacking.net 
...
It was clarified later that [Disch appreciates corrections](http://forums.nesdev.org/viewtopic.php?f=3&t=10275). 
