...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Software_Serial_Routine) | View [other pages](Special_AllPages.xhtml#Software_Serial_Routine)

This page covers implementation of bit-banged serial read/write routines for use with a [Serial Cable](https://www.nesdev.org/w/index.php?title=Serial_Cable&action=edit&redlink=1 "Serial Cable \(page does not exist\)"). It's meant if you're implementing your own, or want to understand how the library routines work. 
