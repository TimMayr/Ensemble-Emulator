...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Template%3ASu) | View [other pages](Special_AllPages.xhtml#Template_Su)
...
[ko:틀:Su](https://www.nesdev.org/w/index.php?title=Ko:%ED%8B%80:Su&action=edit&redlink=1 "Ko:틀:Su \(page does not exist\)")

|  The above [documentation](https://en.wikipedia.org/wiki/Wikipedia:Template_documentation "wikipedia:Wikipedia:Template documentation") is [transcluded](https://en.wikipedia.org/wiki/Wikipedia:Transclusion "wikipedia:Wikipedia:Transclusion") from [Template:Su/doc](Template_Su_doc.xhtml "Template:Su/doc"). ([edit](https://www.nesdev.org/w/index.php?title=Template:Su/doc&action=edit) | [history](https://www.nesdev.org/w/index.php?title=Template:Su/doc&action=history))   
Editors can experiment in this template's sandbox ([create](https://www.nesdev.org/w/index.php?title=Template:Su/sandbox&action=edit&preload=Template:Documentation/preload-sandbox)) and testcases ([create](https://www.nesdev.org/w/index.php?title=Template:Su/testcases&action=edit&preload=Template:Documentation/preload-testcases)) pages.   
Please add categories and interwikis to the [/doc](Template_Su_doc.xhtml "Template:Su/doc") subpage. ~~Subpages of this template~~.   
---|---  
  
Categories: [Mathematical formatting templates](Category_Mathematical_formatting_templates.xhtml), [Wikipedia formatting and function templates](Category_Wikipedia_formatting_and_function_templates.xhtml)
