...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/User_talk%3AKaratorian/6502_Instruction_Set) | View [other pages](Special_AllPages.xhtml#User_talk_Karatorian_6502_Instruction_Set)
...
Can you also add the stable unofficial codes to this table (perhaps in italics so that you can know the difference)? --[Zzo38](User_Zzo38.xhtml "User:Zzo38") ([talk](User_talk_Zzo38.xhtml "User talk:Zzo38")) 19:59, 11 October 2013 (MDT) 
