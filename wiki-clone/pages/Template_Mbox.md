...
From [NESdev Wiki](Nesdev_Wiki.xhtml) | View [current version](https://www.nesdev.org/wiki/Template%3AMbox) | View [other pages](Special_AllPages.xhtml#Template_Mbox)

![](../wiki-images/Ambox_notice.png) |  {{{text}}}   
---|---  
...
This template calls `{{[mbox/core](Template_Mbox_core.xhtml "Template:Mbox/core")}}` which holds most of the code for `{{mbox}}`, while `{{mbox}}` itself does parameter preprocessing. 
...
|  The above [documentation](https://en.wikipedia.org/wiki/Wikipedia:Template_documentation "wikipedia:Wikipedia:Template documentation") is [transcluded](https://en.wikipedia.org/wiki/Wikipedia:Transclusion "wikipedia:Wikipedia:Transclusion") from [Template:Mbox/doc](Template_Mbox_doc.xhtml "Template:Mbox/doc"). ([edit](https://www.nesdev.org/w/index.php?title=Template:Mbox/doc&action=edit) | [history](https://www.nesdev.org/w/index.php?title=Template:Mbox/doc&action=history))   
Editors can experiment in this template's sandbox ([create](https://www.nesdev.org/w/index.php?title=Template:Mbox/sandbox&action=edit&preload=Template:Documentation/preload-sandbox)) and testcases ([create](https://www.nesdev.org/w/index.php?title=Template:Mbox/testcases&action=edit&preload=Template:Documentation/preload-testcases)) pages.   
Please add categories and interwikis to the [/doc](Template_Mbox_doc.xhtml "Template:Mbox/doc") subpage. ~~Subpages of this template~~.   
---|---
